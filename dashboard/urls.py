...
urlpatterns = [
    ...
    path('contactus/<int:pk>', views.ContactUsDetail.as_view() , name='contact_us_detail'),
    path('contact-us_active/<int:pk>', views.ContactUsActive.as_view() , name='contact_us_active'),
    path('contact-us-delete/<int:pk>', views.ContactUsDelete.as_view() , name='contact_us_delete'),
